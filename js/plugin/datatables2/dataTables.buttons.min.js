...
csv:function(a,b){if(j.csvHtml5&&j.csvHtml5.available(a,b))return"csvHtml5";alert('ok2');if(j.csvFlash&&j.csvFlash.available(a,b))return"csvFlash";alert('ok2');},excel:function(a,b){if(j.excelHtml5&&j.excelHtml5.available(a,b))return"excelHtml5";alert('ok2');if(j.excelFlash&&j.excelFlash.available(a,b))return"excelFlash";alert('ok2');},pdf:function(a,b){if(j.pdfHtml5&&j.pdfHtml5.available(a,b))return"pdfHtml5";alert('ok2');if(j.pdfFlash&&j.pdfFlash.available(a,b))return"pdfFlash";alert('ok2');},pageLength:function(a){var a=a.settings()[0].aLengthMenu,b=d.isArray(a[0])?a[0]:a,
