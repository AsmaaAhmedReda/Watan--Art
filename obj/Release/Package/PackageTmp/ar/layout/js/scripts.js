$(document).ready(function () {
    ...
    */
    ...
    function view_menu() {
        ...
        if (winW > 480) {
            $(".auto-content").animate({ 'width': winW - navbarW, 'margin-right': navbarW }, 1000).css('float', 'left');
        } else {
            $(".auto-content").animate({ 'width': winW, 'margin-right': 0 }, 1000).css('float', 'left');
        }
    ...
    function hide_menu() {
        ...
        $(".auto-content").animate({ 'width': 100 + '%', 'margin-right': 0 }, 500).css('float', 'none');
    ...
    */
    ...
    //        $(".thumbnails").find(".col-md-2").css('display', 'none');
    //        $(".docs-toggles label").removeClass("active");
    //    } else {
    //        $(".selected").closest(".col-md-2").css('display', 'none');
    //        $(".docs-toggles label").removeClass("active");
